...
class FygUser {
  ...
  public FygUser(Integer id, String name, Integer age) {
    this.id = id;
    this.name = name;
    this.age = age;
  }
...
class FygSong {
  ...
  public FygSong(Integer id, String name, String artist) {
    this.id = id;
    this.name = name;
    this.artist = artist;
  }
...
class FygPlaylist {
  ...
  public FygPlaylist(Integer id, String name, Integer userId, List<Integer> songs) {
    this.id = id;
    this.name = name;
    this.userId = userId;
    this.songs = songs;
